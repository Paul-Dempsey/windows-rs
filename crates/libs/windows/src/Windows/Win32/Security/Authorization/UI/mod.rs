...
impl IEffectivePermission2 {
    ...
    pub unsafe fn ComputeEffectivePermissionWithSecondarySecurity<'a, P0, P1, P2>(
        ...
        pusergroups: ::core::option::Option<*mut super::super::TOKEN_GROUPS>,
        pauthzusergroupsoperations: ::core::option::Option<*mut super::AUTHZ_SID_OPERATION>,
        pdevicegroups: ::core::option::Option<*mut super::super::TOKEN_GROUPS>,
        pauthzdevicegroupsoperations: ::core::option::Option<*mut super::AUTHZ_SID_OPERATION>,
        pauthzuserclaims: ::core::option::Option<*mut super::AUTHZ_SECURITY_ATTRIBUTES_INFORMATION>,
        pauthzuserclaimsoperations: ::core::option::Option<*mut super::AUTHZ_SECURITY_ATTRIBUTE_OPERATION>,
        pauthzdeviceclaims: ::core::option::Option<*mut super::AUTHZ_SECURITY_ATTRIBUTES_INFORMATION>,
        pauthzdeviceclaimsoperations: ::core::option::Option<*mut super::AUTHZ_SECURITY_ATTRIBUTE_OPERATION>,
...
pub struct IEffectivePermission2_Vtbl {
    ...
    pub ComputeEffectivePermissionWithSecondarySecurity: unsafe extern "system" fn(
        ...
        psecurityobjects: *mut SECURITY_OBJECT,
        dwsecurityobjectcount: u32,
        pusergroups: *mut super::super::TOKEN_GROUPS,
        pauthzusergroupsoperations: *mut super::AUTHZ_SID_OPERATION,
        pdevicegroups: *mut super::super::TOKEN_GROUPS,
        pauthzdevicegroupsoperations: *mut super::AUTHZ_SID_OPERATION,
        pauthzuserclaims: *mut super::AUTHZ_SECURITY_ATTRIBUTES_INFORMATION,
        pauthzuserclaimsoperations: *mut super::AUTHZ_SECURITY_ATTRIBUTE_OPERATION,
        pauthzdeviceclaims: *mut super::AUTHZ_SECURITY_ATTRIBUTES_INFORMATION,
        pauthzdeviceclaimsoperations: *mut super::AUTHZ_SECURITY_ATTRIBUTE_OPERATION,
        peffpermresultlists: *mut EFFPERM_RESULT_LIST,
