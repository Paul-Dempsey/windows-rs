...
impl IWsbApplicationBackupSupport {
    pub unsafe fn CheckConsistency(&self, wszwritermetadata: ::windows::core::PWSTR, wszcomponentname: ::windows::core::PWSTR, wszcomponentlogicalpath: ::windows::core::PWSTR, cvolumes: u32, rgwszsourcevolumepath: *mut ::windows::core::PWSTR, rgwszsnapshotvolumepath: *mut ::windows::core::PWSTR) -> ::windows::core::Result<IWsbApplicationAsync> {
        let mut result__ = ::core::mem::MaybeUninit::zeroed();
        (::windows::core::Vtable::vtable(self).CheckConsistency)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(wszwritermetadata), ::core::mem::transmute(wszcomponentname), ::core::mem::transmute(wszcomponentlogicalpath), cvolumes, ::core::mem::transmute(rgwszsourcevolumepath), ::core::mem::transmute(rgwszsnapshotvolumepath), ::core::mem::transmute(result__.as_mut_ptr())).from_abi::<IWsbApplicationAsync>(result__)
    }
}
...
pub struct IWsbApplicationBackupSupport_Vtbl {
    pub base__: ::windows::core::IUnknown_Vtbl,
    pub CheckConsistency: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, wszwritermetadata: ::windows::core::PWSTR, wszcomponentname: ::windows::core::PWSTR, wszcomponentlogicalpath: ::windows::core::PWSTR, cvolumes: u32, rgwszsourcevolumepath: *mut ::windows::core::PWSTR, rgwszsnapshotvolumepath: *mut ::windows::core::PWSTR, ppasync: *mut *mut ::core::ffi::c_void) -> ::windows::core::HRESULT,
}
#[doc = "*Required features: `\"Win32_System_ServerBackup\"`*"]
#[repr(transparent)]
...
impl IWsbApplicationRestoreSupport {
    ...
    pub unsafe fn PreRestore<'a, P0>(&self, wszwritermetadata: ::windows::core::PWSTR, wszcomponentname: ::windows::core::PWSTR, wszcomponentlogicalpath: ::windows::core::PWSTR, bnorollforward: P0) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<super::super::Foundation::BOOLEAN>,
    {
        (::windows::core::Vtable::vtable(self).PreRestore)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(wszwritermetadata), ::core::mem::transmute(wszcomponentname), ::core::mem::transmute(wszcomponentlogicalpath), bnorollforward.into()).ok()
    }
    #[doc = "*Required features: `\"Win32_Foundation\"`*"]
    #[cfg(feature = "Win32_Foundation")]
    pub unsafe fn PostRestore<'a, P0>(&self, wszwritermetadata: ::windows::core::PWSTR, wszcomponentname: ::windows::core::PWSTR, wszcomponentlogicalpath: ::windows::core::PWSTR, bnorollforward: P0) -> ::windows::core::Result<()>
    where
        P0: ::std::convert::Into<super::super::Foundation::BOOLEAN>,
    {
        (::windows::core::Vtable::vtable(self).PostRestore)(::windows::core::Vtable::as_raw(self), ::core::mem::transmute(wszwritermetadata), ::core::mem::transmute(wszcomponentname), ::core::mem::transmute(wszcomponentlogicalpath), bnorollforward.into()).ok()
    }
    pub unsafe fn OrderComponents(&self, ccomponents: u32, rgcomponentname: *mut ::windows::core::PWSTR, rgcomponentlogicalpaths: *mut ::windows::core::PWSTR, prgcomponentname: *mut *mut ::windows::core::PWSTR, prgcomponentlogicalpath: *mut *mut ::windows::core::PWSTR) -> ::windows::core::Result<()> {
...
pub struct IWsbApplicationRestoreSupport_Vtbl {
    pub base__: ::windows::core::IUnknown_Vtbl,
    #[cfg(feature = "Win32_Foundation")]
    pub PreRestore: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, wszwritermetadata: ::windows::core::PWSTR, wszcomponentname: ::windows::core::PWSTR, wszcomponentlogicalpath: ::windows::core::PWSTR, bnorollforward: super::super::Foundation::BOOLEAN) -> ::windows::core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    PreRestore: usize,
    #[cfg(feature = "Win32_Foundation")]
    pub PostRestore: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, wszwritermetadata: ::windows::core::PWSTR, wszcomponentname: ::windows::core::PWSTR, wszcomponentlogicalpath: ::windows::core::PWSTR, bnorollforward: super::super::Foundation::BOOLEAN) -> ::windows::core::HRESULT,
    #[cfg(not(feature = "Win32_Foundation"))]
    PostRestore: usize,
    pub OrderComponents: unsafe extern "system" fn(this: *mut ::core::ffi::c_void, ccomponents: u32, rgcomponentname: *mut ::windows::core::PWSTR, rgcomponentlogicalpaths: *mut ::windows::core::PWSTR, prgcomponentname: *mut *mut ::windows::core::PWSTR, prgcomponentlogicalpath: *mut *mut ::windows::core::PWSTR) -> ::windows::core::HRESULT,
