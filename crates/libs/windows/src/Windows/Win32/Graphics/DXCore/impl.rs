...
pub trait IDXCoreAdapterFactory_Impl: Sized {
    ...
    fn RegisterEventNotification(&self, dxcoreobject: &::core::option::Option<::windows::core::IUnknown>, notificationtype: DXCoreNotificationType, callbackfunction: &PFN_DXCORE_NOTIFICATION_CALLBACK, callbackcontext: *mut ::core::ffi::c_void) -> ::windows::core::Result<u32>;
